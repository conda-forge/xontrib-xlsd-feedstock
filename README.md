...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xontrib-xlsd-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10622&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xontrib-xlsd-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xontrib-xlsd` can be installed with:

```
conda install xontrib-xlsd
```

It is possible to list all of the versions of `xontrib-xlsd` available on your platform with:
